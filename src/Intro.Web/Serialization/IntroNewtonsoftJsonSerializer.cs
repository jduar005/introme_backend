...
{
    public class IntroNewtonsoftJsonSerializer : ISerializer
    {
        ...
        /// </summary>
        public IntroNewtonsoftJsonSerializer()
        {
        ...
        public IntroNewtonsoftJsonSerializer(JsonSerializer serializer)
        {
